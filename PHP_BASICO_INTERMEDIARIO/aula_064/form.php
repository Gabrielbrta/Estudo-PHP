                ...
                <form action="submissao.php" method="post" name="formulario">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="check_2" value="check 2"
                                    id="check_2">
                                <label for="check_2" class="form-check-label">Texto da checkbox 2</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="check_3" value="check 3"
                                    id="check_3">
                        ...
                        <div class="col-sm-6">
                            <!-- radiobuttons -->
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="radio" value="radio 1" id="radio_1">
                                <label for="radio_1" class="form-check-label">Opção 1</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="radio" value="radio 2" id="radio_2">
                                <label for="radio_2" class="form-check-label">Opção 2</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="radio" value="radio 3" id="radio_3">
